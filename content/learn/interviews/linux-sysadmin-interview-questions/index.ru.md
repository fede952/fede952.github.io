...
aliases: ["/ru/interviews/linux-sysadmin-interview-questions/"]
---
...
**Нужна быстрая справка по командам?** Держите наш [Шпаргалку Linux SysAdmin](/ru/learn/cheatsheets/linux-sysadmin-permissions/) открытой во время подготовки.
