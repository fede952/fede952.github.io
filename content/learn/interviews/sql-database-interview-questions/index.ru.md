...
aliases: ["/ru/interviews/sql-database-interview-questions/"]
---
...
**Нужна быстрая справка по SQL?** Держите наш [Cheatsheet по SQL-инъекциям и запросам к базам данных](/ru/learn/cheatsheets/sql-injection-payloads-database/) открытым во время подготовки.
