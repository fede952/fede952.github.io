...
**Related Resource:** Base64 encoding is commonly used to obfuscate payloads. See our [SQL Injection Pentester's Cheatsheet](/en/learn/cheatsheets/sql-injection-payloads-database/) for real-world examples.
