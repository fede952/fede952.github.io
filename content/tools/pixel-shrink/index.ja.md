...
大きな画像はウェブサイトを遅くし、ストレージを消費し、帯域幅を浪費します。ほとんどのオンライン圧縮ツールはファイルをリモートサーバーにアップロードさせます。つまり、見知らぬ人のマシンがあなたの個人的な写真、スクリーンショット、ドキュメントを処理するということです。ブラウザだけでローカルに処理できる作業に、不必要なプライバシーリスクを負う必要はありません。
