...
GlitchForge pone estas técnicas en tu navegador. Sube cualquier foto y manipúlala en tiempo real usando cuatro controles independientes: **Amount** añade contraste y ruido digital, **RGB Shift** separa los canales rojo y azul para crear aberración cromática, **Scanlines** superpone un efecto de monitor CRT, y **Pixel Sort** arrastra los píxeles verticalmente según la luminancia — el aspecto característico del glitch art algorítmico. Todo se ejecuta en la API Canvas dentro de tu navegador; tus imágenes nunca se suben a ningún servidor.
